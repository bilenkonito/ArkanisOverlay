...
public class OrgSettingsEndpoint(IMedRunnerClientConfig config, IMedRunnerTokenProvider tokenProvider, IMemoryCache cache, ILogger<OrgSettingsEndpoint> logger)
