...
public class EmergencyEndpoint(IMedRunnerClientConfig config, IMedRunnerTokenProvider tokenProvider, IMemoryCache cache, ILogger<EmergencyEndpoint> logger)
