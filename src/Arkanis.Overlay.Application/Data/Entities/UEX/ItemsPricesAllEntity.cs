...
public class ItemsPricesAllEntity : BaseEntity
{
    ...
    public decimal PriceBuy { get; set; } // last, per unit

    [JsonPropertyName("price_buy_min")]
    public decimal PriceBuyMin { get; set; }

    [JsonPropertyName("price_buy_min_week")]
    public decimal PriceBuyMinWeek { get; set; }

    [JsonPropertyName("price_buy_min_month")]
    public decimal PriceBuyMinMonth { get; set; }

    [JsonPropertyName("price_buy_max")]
    public decimal PriceBuyMax { get; set; }

    [JsonPropertyName("price_buy_max_week")]
    public decimal PriceBuyMaxWeek { get; set; }

    [JsonPropertyName("price_buy_max_month")]
    public decimal PriceBuyMaxMonth { get; set; }

    [JsonPropertyName("price_buy_avg")]
    public decimal PriceBuyAvg { get; set; }

    [JsonPropertyName("price_buy_avg_week")]
    public decimal PriceBuyAvgWeek { get; set; }

    [JsonPropertyName("price_buy_avg_month")]
    public decimal PriceBuyAvgMonth { get; set; }

    [JsonPropertyName("price_sell")]
    public decimal PriceSell { get; set; } // last, per unit

    [JsonPropertyName("price_sell_min")]
    public decimal PriceSellMin { get; set; }

    [JsonPropertyName("price_sell_min_week")]
    public decimal PriceSellMinWeek { get; set; }

    [JsonPropertyName("price_sell_min_month")]
    public decimal PriceSellMinMonth { get; set; }

    [JsonPropertyName("price_sell_max")]
    public decimal PriceSellMax { get; set; }

    [JsonPropertyName("price_sell_max_week")]
    public decimal PriceSellMaxWeek { get; set; }

    [JsonPropertyName("price_sell_max_month")]
    public decimal PriceSellMaxMonth { get; set; }

    [JsonPropertyName("price_sell_avg")]
    public decimal PriceSellAvg { get; set; }

    [JsonPropertyName("price_sell_avg_week")]
    public decimal PriceSellAvgWeek { get; set; }

    [JsonPropertyName("price_sell_avg_month")]
    public decimal PriceSellAvgMonth { get; set; }

    [JsonPropertyName("durability")]
    public decimal Durability { get; set; } // last (%)

    [JsonPropertyName("durability_min")]
    public decimal DurabilityMin { get; set; }

    [JsonPropertyName("durability_min_week")]
    public decimal DurabilityMinWeek { get; set; }

    [JsonPropertyName("durability_min_month")]
    public decimal DurabilityMinMonth { get; set; }

    [JsonPropertyName("durability_max")]
    public decimal DurabilityMax { get; set; }

    [JsonPropertyName("durability_max_week")]
    public decimal DurabilityMaxWeek { get; set; }

    [JsonPropertyName("durability_max_month")]
    public decimal DurabilityMaxMonth { get; set; }

    [JsonPropertyName("durability_avg")]
    public decimal DurabilityAvg { get; set; }

    [JsonPropertyName("durability_avg_week")]
    public decimal DurabilityAvgWeek { get; set; }

    [JsonPropertyName("durability_avg_month")]
    public decimal DurabilityAvgMonth { get; set; }

    [JsonPropertyName("faction_affinity")]
    public int FactionAffinity { get; set; } // datarunner's affinity average at a location (between -100 and 100)
    ...
    [JsonPropertyName("terminal_is_player_owned")]
