...
using Arkanis.Overlay.Application.Data.Entities.Overlay;
using Arkanis.Overlay.Application.Data.Enums;
using Arkanis.Overlay.Application.Data.Records;
using Arkanis.Overlay.Application.Data.Structs;
...
public partial class SearchService(IMemoryCache cache, UEXContext dbContext, ILogger<SearchService> logger) : ISearchService
{
    ...
    public Task<IEnumerable<LocationPrice>> GetDetailedPricesAsync(EntityType entityType, string name,
        PriceType? priceType = null, string? location = null)
    {
    ...
    private async Task<IEnumerable<SearchResult>> SearchVehiclesAsync(string query, bool includeShips,
