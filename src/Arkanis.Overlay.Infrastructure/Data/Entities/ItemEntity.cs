...
public class ItemEntity : BaseEntity
{
    ...
    public int? IdCategory { get; set; } // int(11)

    [JsonPropertyName("id_company")]
    public int? IdCompany { get; set; } // int(11)

    [JsonPropertyName("id_vehicle")]
    public int? IdVehicle { get; set; } // int(11) // if linked to a vehicle

    [JsonPropertyName("name")]
    public string? Name { get; set; } // string(255)

    [JsonPropertyName("section")]
    public string? Section { get; set; } // string(255) // coming from categories

    [JsonPropertyName("category")]
    public string? Category { get; set; } // string(255) // coming from categories

    [JsonPropertyName("company_name")]
    public string? CompanyName { get; set; } // string(255) // coming from companies

    [JsonPropertyName("vehicle_name")]
    public string? VehicleName { get; set; } // string(255) // coming from vehicles

    [JsonPropertyName("slug")]
    public string? Slug { get; set; } // string(255) // UEX URLs

    [JsonPropertyName("uuid")]
    public string? Uuid { get; set; } // string(255) // star citizen uuid

    [JsonPropertyName("url_store")]
    public string? UrlStore { get; set; } // string(255) // pledge store URL
