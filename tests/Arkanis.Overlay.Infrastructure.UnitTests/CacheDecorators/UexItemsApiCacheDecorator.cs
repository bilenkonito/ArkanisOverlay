...
public sealed class UexItemsApiCacheDecorator(IUexItemsApi itemsApi, ILogger<UexItemsApiCacheDecorator> logger) : ServiceCacheDecorator(logger), IUexItemsApi
{
